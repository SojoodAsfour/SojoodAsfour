...
## 👩‍💻 Sojood Asfour – Computer Engineering Student
...
![MIPS](https://img.shields.io/badge/MIPS-Assembly-red?style=for-the-badge)
...
![NLTK](https://img.shields.io/badge/NLTK-00A4EF?style=for-the-badge)
...
## 🧠 Data Structures & Algorithms
- Linked Lists (with Undo functionality)  
- Stacks & Queues  
- Binary Search Trees (BST restructuring & statistics)  
- Graph Algorithms (Prim & Kruskal – MST)  
- Maximum Clique Detection (MIPS)  

---

## 🏗️ Computer Architecture
- 16-bit Single-Cycle RISC Processor (Logisim)  
- Multi-Cycle Processor Design  
- 32-bit Predicated RISC Processor (Verilog)  
- MIPS Assembly Implementation  
- Datapath & Control Unit Design  
- Instruction Encoding & RTL Verification  

---

## 🔌 Digital Design (Verilog)
- n-Digit BCD Adder (Ripple Carry & Carry Lookahead)  
- BCD Subtraction using 10’s Complement  
- Structural Gate-Level Design  
- Timing Analysis & Maximum Clock Frequency Calculation  
